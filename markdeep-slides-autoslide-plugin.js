...
if(isActive){
    ...
    function autoslider_autoslide(){
        ...
        if(autoslider_growingProgressbar){
            autoslider_growingProgressbarStyle = `.autoslider_growingProgressbar{width:100%;height:2px;background-color:${autoslider_growingProgressbarColor};animation:grow ${autoslider_seconds}s 1 linear;}@keyframes grow{0%{width:0}100%{width:100%}}`;
